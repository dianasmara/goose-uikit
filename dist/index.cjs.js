...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#011b45", backgroundDisabled: "#f7eb05", contrast: "#191326", invertedContrast: "#011b45", input: "#eeeaf4", tertiary: "#ED4B9E", text: "#ED4B9E", textDisabled: "#BDC2C4", textSubtle: "#8f80ba", borderColor: "#011b45", card: "#011b45", gradients: {
 ...
 var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#343135", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#d40000", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#27262c", gradients: {
