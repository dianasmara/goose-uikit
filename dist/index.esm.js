...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#ED4B9E", backgroundDisabled: "#f7eb05", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#ED4B9E", text: "#ED4B9E", textDisabled: "#BDC2C4", textSubtle: "#8f80ba", borderColor: "#05f719", card: "#FFFFFF", gradients: {
